      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          {trendingPrompts.map((prompt, index) => (
            <div key={prompt.id} className="bg-white bg-opacity-10 backdrop-blur-sm rounded-lg p-4 border border-white border-opacity-20">
              ...
              <p className="text-gray-200 text-sm">{prompt.category}</p>
            </div>
          ))}
        </div>
      </div>
